...
const SellYourHomeContainer = ({ imageId, homeActionText, propWidth }) => {
  ...
  return (
    <div
      className="rounded bg-gray-white shadow-[0px_24px_68px_rgba(59,_77,_129,_0.08)] flex flex-col items-start justify-start p-[22px] box-border min-w-[300px] max-w-[340px] text-center text-5xl text-gray-700 font-body-large-400"
